...
export default function ProfileSetup() {
  ...
  const handleSubmit = async (e) => {
    ...
    const profile = {
      ...
      emergency_contact_name: formData.get('emergency-contact-name') || null,
      emergency_contact_phone: formData.get('emergency-contact-phone') || null,
      emergency_contact_relationship: formData.get('emergency-contact-relationship') || null,
    }
